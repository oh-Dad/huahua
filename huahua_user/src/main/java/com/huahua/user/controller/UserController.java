...
public class UserController {
	...
	public Result delete(@PathVariable String id ){
		...
		//Authorization: Bearer  asdsadasdasdasdasd.asdasdasdasd.asdsadasdasdasdas
		//获取请求头中的数据
	/*	String header = request.getHeader("Authorization");//Authorization参数名称
		if (StringUtils.isEmpty(header)){
			return new Result(true,StatusCode.LOGINERROR,"登录有误，请返回重新登录");
		}
		...
		//效验claims不能为空
		if (null == claims){
			return  new Result(true,StatusCode.LOGINERROR,"登陆异常");
		}
		//判断  必须拥有管理员权限  否则不能删除
