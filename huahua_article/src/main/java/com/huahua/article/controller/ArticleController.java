...
public class ArticleController {
	...
	public Result channellist(@PathVariable String channelid,@PathVariable Integer page,@PathVariable Integer size){

		Page<Article> problemPage = articleService.channellist(channelid, page, size);
	...
	public Result columnlist(@PathVariable String columnid,@PathVariable Integer page,@PathVariable Integer size){

		Page<Article> problemPage = articleService.columnlist(columnid, page, size);
		return new Result(true,StatusCode.OK,"查询成功",new PageResult<>(problemPage.getTotalElements(),problemPage.getContent()));
	}
	/**
	 * 头条文章
